...
document.getElementById("mu_varatha").innerHTML = '**' + kural.allKural[random].mu_varatha[0] + '**' + ': ' + kural.allKural[random].mv
...
document.getElementById("mu_karu").innerHTML = '**' + kural.allKural[random].mu_karu[0] + '**' + ': ' + kural.allKural[random].mk
document.getElementById("salaman").innerHTML = '**' + kural.allKural[random].salaman[0] + '**' + ': ' + kural.allKural[random].sp
